...
class NeflixViewController: UIViewController {
    ...
    var imageArray = ["알라딘","7번방의선물","아바타","광해","겨울왕국2","괴물","극한직업","국제시장","명량","베테랑","부산행","신과함께인과연","신과함께죄와벌","암살","어벤져스엔드게임","왕의남자","태극기휘날리며","택시운전사","해운대"]
